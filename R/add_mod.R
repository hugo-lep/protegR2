#' @title Fonction pour ajouter des menuItems dans le "sidebar", incluant des menuSubItem
#'
...
#'
#' @importFrom shinydashboard menuItem tabItem
...
#' @title fct pour ajouter des modules à l'application
#'
...
#'
#' @importFrom shinydashboard  tabItem menuSubItem
#'
